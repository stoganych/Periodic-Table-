...
INSERT INTO public.properties VALUES (2, 1, 4.003, -272.2, -269);
INSERT INTO public.properties VALUES (3, 2, 6.94, 180.54, 1342);
INSERT INTO public.properties VALUES (4, 2, 9.012, 1287, 2470);
...
--
-- Name: properties fk_type_key; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_type_key FOREIGN KEY (type_id) REFERENCES public.types(type_id);
